...
* [Angular](https://github.com/supabase/supabase/tree/master/examples/user-management/angular-user-management) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Expo](https://github.com/supabase/supabase/tree/master/examples/user-management/expo-user-management) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Flutter](https://github.com/supabase/supabase/tree/master/examples/user-management/flutter-user-management) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Next.js (TS)](https://github.com/supabase/supabase/tree/master/examples/user-management/nextjs-ts-user-management) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Nuxt](https://github.com/supabase/supabase/tree/master/examples/user-management/nuxtjs-user-management) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Nuxt3](https://github.com/supabase/supabase/tree/master/examples/user-management/nuxt3-user-management) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![auth](https://img.shields.io/badge/-auth-informational)
* [React](https://github.com/supabase/supabase/tree/master/examples/user-management/react-user-management) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Solid](https://github.com/supabase/supabase/tree/master/examples/user-management/solid-user-management) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Svelte](https://github.com/supabase/supabase/tree/master/examples/user-management/svelte-user-management) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Svelte Kit](https://github.com/supabase/supabase/tree/master/examples/user-management/sveltekit-user-management) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Vue 3](https://github.com/supabase/supabase/tree/master/examples/user-management/vue3-user-management) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Next.js, Slack Clone](https://github.com/supabase/supabase/tree/master/examples/slack-clone/nextjs-slack-clone) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![realtime](https://img.shields.io/badge/-realtime-orange)
* [Svelte, Todo list](https://github.com/supabase/supabase/tree/master/examples/todo-list/sveltejs-todo-list) ⭐ 97,319 | 🐛 848 | 🌐 TypeScript | 📅 2026-02-06 - ![database](https://img.shields.io/badge/-database-9cf)
...
* [Flutter, Stripe Payments](https://github.com/supabase-community/flutter-stripe-payments-with-supabase-functions) ⭐ 93 | 🐛 0 | 🌐 Dart | 📅 2024-04-27 - ![edge functions](https://img.shields.io/badge/-edge%20functions-darkgreen)

## Community Starters

* [Extro](https://github.com/turbostarter/extro) ⭐ 360 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-16 - Open source browser extension starter kit.
* [SupaSasS Lite](https://github.com/Razikus/supabase-nextjs-template) ⭐ 285 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-06 - Open source Next.js SasS template (with 2FA, and example app)
* [Vuepabase](https://github.com/JMaylor/vuepabase) ⭐ 59 | 🐛 0 | 🌐 Vue | 📅 2022-10-12 - Vue3 Supabase starter, with Pinia, Vue-router 4, TailwindCSS, Vitest, Cypress and more.
* [SupaSocial](https://github.com/koji0701/supabase-react-social-media-starter/tree/main) ⭐ 23 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-26 - React social media starter with auth, friend requests, profile pics, and example app (profile, friends, signin, leaderboard, and more pages).
...
* [Supabase DB to Google Sheets](https://github.com/jadynekena/supabase-googlesheet) ⭐ 41 | 🐛 0 | 🌐 JavaScript | 📅 2022-09-03 - Tool to pull Supabase data into Google Sheets.
...
* [Supabase Plus](https://github.com/dsplce-co/supabase-plus) ⭐ 66 | 🐛 0 | 🌐 Rust | 📅 2026-02-06 - An extra set of tools for managing Supabase projects, going beyond the possibilities of the regular Supabase CLI.

## Community Tools

* [Supabase Cache Helpers](https://github.com/psteinroe/supabase-cache-helpers) ⭐ 663 | 🐛 53 | 🌐 TypeScript | 📅 2026-02-04 - Collection of framework specific Cache utilities for working with Supabase.
* [Supabase automated self host](https://github.com/singh-inder/supabase-automated-self-host) ⭐ 435 | 🐛 2 | 🌐 Shell | 📅 2026-02-06 - Self-host Supabase with Caddy and Authelia. Just run ONE script.
* [Generate Supabase Database Types GitHub Action](https://github.com/lyqht/generate-supabase-db-types-github-action) ⭐ 66 | 🐛 6 | 🌐 TypeScript | 📅 2023-05-29 - GitHub action to generate types based on your Supabase database.
...
* [Bemi for Supabase JS](https://github.com/BemiHQ/bemi-supabase-js) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2025-11-07 - Open-source platform for automatic data change tracking.
