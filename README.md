...
* [Angular](https://github.com/supabase/supabase/tree/master/examples/user-management/angular-user-management) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Expo](https://github.com/supabase/supabase/tree/master/examples/user-management/expo-user-management) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Flutter](https://github.com/supabase/supabase/tree/master/examples/user-management/flutter-user-management) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Next.js (TS)](https://github.com/supabase/supabase/tree/master/examples/user-management/nextjs-ts-user-management) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Nuxt](https://github.com/supabase/supabase/tree/master/examples/user-management/nuxtjs-user-management) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Nuxt3](https://github.com/supabase/supabase/tree/master/examples/user-management/nuxt3-user-management) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![auth](https://img.shields.io/badge/-auth-informational)
* [React](https://github.com/supabase/supabase/tree/master/examples/user-management/react-user-management) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Solid](https://github.com/supabase/supabase/tree/master/examples/user-management/solid-user-management) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Svelte](https://github.com/supabase/supabase/tree/master/examples/user-management/svelte-user-management) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Svelte Kit](https://github.com/supabase/supabase/tree/master/examples/user-management/sveltekit-user-management) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Vue 3](https://github.com/supabase/supabase/tree/master/examples/user-management/vue3-user-management) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![auth](https://img.shields.io/badge/-auth-informational)
* [Next.js, Slack Clone](https://github.com/supabase/supabase/tree/master/examples/slack-clone/nextjs-slack-clone) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![realtime](https://img.shields.io/badge/-realtime-orange)
* [Svelte, Todo list](https://github.com/supabase/supabase/tree/master/examples/todo-list/sveltejs-todo-list) ⭐ 99,578 | 🐛 962 | 🌐 TypeScript | 📅 2026-03-25 - ![database](https://img.shields.io/badge/-database-9cf)
...
* [Extro](https://github.com/turbostarter/extro) ⭐ 369 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-16 - Open source browser extension starter kit.
* [SupaSasS Lite](https://github.com/Razikus/supabase-nextjs-template) ⭐ 299 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-06 - Open source Next.js SasS template (with 2FA, and example app)
...
* [Supabase automated self host](https://github.com/singh-inder/supabase-automated-self-host) ⭐ 463 | 🐛 2 | 🌐 Shell | 📅 2026-03-19 - Self-host Supabase with Caddy and Authelia. Just run ONE script.
